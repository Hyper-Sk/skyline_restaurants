    ...
    try {
        ...
        <tr>
            <th
                style='font-size: 14px; border: 1px solid rgba(0,0,0,0.2); text-align: left; padding: 8px 10px;width: 180px;'>
                Total Persons </th>
            <td style='font-size: 14px; border: 1px solid rgba(0,0,0,0.2);padding: 8px 10px;'>$members</td>
        </tr>
        <tr>
            <th
                style='font-size: 14px; border: 1px solid rgba(0,0,0,0.2); text-align: left; padding: 8px 10px;width: 180px;'>
                Date </th>
            <td style='font-size: 14px; border: 1px solid rgba(0,0,0,0.2);padding: 8px 10px;'>$date</td>
        </tr>
        <tr>
            <th
                style='font-size: 14px; border: 1px solid rgba(0,0,0,0.2); text-align: left; padding: 8px 10px;width: 180px;'>
                Time </th>
            <td style='font-size: 14px; border: 1px solid rgba(0,0,0,0.2);padding: 8px 10px;'>$time</td>
        </tr>
        <tr>
            <th
                style='font-size: 14px; border: 1px solid rgba(0,0,0,0.2); text-align: left; padding: 8px 10px;width: 180px;'>
        ...
        <tr style='background-color: #1a1a1a;'>
            <td colspan='2' style='padding:10px; color: white;'>
                ...
                <a target='_blank' href='https://skylinerestaurants.com' style='color: #e8e8e8; font-size: 14px;'>
